...
export const experience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    description:
      "My first real job. Automated ETL pipelines with SSIS/SSRS for regulatory reporting, built REST APIs in Django, and used OpenCV to pull data off NIC cards.",
  },
];
